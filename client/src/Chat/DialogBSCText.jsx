    ...
    return (
        <>
            <DialogContentText id="alert-dialog-description">
                At this phase the app is limited to <a href="https://www.binance.org/en/smartChain" target="_blank" rel="noopener noreferrer">Binance Smart Chain (BSC Mainnet)</a> blockchain, so we don't meshup accounts from diferent networks. It could be expanded to use more blockchains later though.
            </DialogContentText>
            <DialogContentText id="alert-dialog-description">
